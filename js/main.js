        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card property-card h-100">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="property-details.html?slug=${property.slug}" class="btn btn-primary mt-auto">
                        View Details
                    </a>
                </div>
            </div>
...
function loadRecentProperties() {
    const recentProperties = allProperties.filter(property => property.recent).slice(0, 6);
